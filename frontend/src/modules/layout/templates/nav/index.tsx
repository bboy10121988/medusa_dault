...
export default async function Nav() {
  ...
  // 暫時使用靜態資料，之後可以從 API 獲取
  const collections: any[] = []
  
  // 從 Sanity 獲取 header 資料
  const headerData = await getHeader()

  // 確保 navigation 資料存在，如果沒有則使用預設值
            ...
            <div className="w-full grid grid-cols-3 items-center">
              ...
              <div className="flex items-center justify-start gap-x-6">
                ...
                <div className="hidden lg:flex items-center gap-x-6">
                  {navigation?.filter((item: {name: string; href: string}) => {
                  ...
                  }).slice(0, 4).map(({ name, href }: {name: string; href: string}, index: number) => {
                ...
                >
                  {headerData?.logo ? (
                    <Image
                      ...
                      className="max-w-[200px] h-auto object-contain transition-all duration-300"
                      style={{ 
              ...
              <div className="flex items-center justify-end gap-x-6">
                ...
                <div className="hidden lg:flex items-center gap-x-4">
                  ...
                  }).slice(0, 2).map(({ name, href }: {name: string; href: string}, index: number) => {
                    if (typeof name !== 'string' || typeof href !== 'string') {
                      return null
                    }
                  ...
                  <Suspense
                    fallback={
                      ...
                      >
                        ...
                        <span className="!text-[13px] !font-medium !leading-none">Cart (0)</span>
                      </LocalizedClientLink>
                    }
                  >
                    <CartButton />
